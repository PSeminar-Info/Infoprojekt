...
namespace GroupCharacter.cHARACTER.Character
{
    public class CharacterMovement : MonoBehaviour
    {
        ...
        private readonly float _maximumWalkVelocity = 0.5f;
        private readonly float _maximuRunVelocity = 2.0f;
        ...
        private void Motion()
        {
            var currentMaxVelocity = _runPressed ? _maximuRunVelocity : _maximumWalkVelocity;
        ...
        private void HandleMovement()
        {
            ...
            if (!attackBowPressed) _animator.SetBool(ArrowStand, false);
